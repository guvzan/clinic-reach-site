  ...
  return (
    <footer className="bg-foreground text-background py-14">
      <div className="container-page grid md:grid-cols-3 gap-10">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-display text-lg">Анна Мельник</p>
        ...
        <div className="text-sm">
          ...
          <a href="tel:+380000000000" className="mt-4 flex items-center gap-2 hover:opacity-100 opacity-90"><Phone className="w-4 h-4" /> +380 (00) 000 00 00</a>
      ...
      <div className="container-page mt-12 pt-6 border-t border-background/15 text-xs opacity-60 flex flex-wrap justify-between gap-3">
        <p>© {new Date().getFullYear()} Анна Мельник. Усі права захищені.</p>
